...
void holyFxRender(CBlob@ this)
{
	array<Vertex> vertlist(0);
	
	CShape@ shape = this.getShape();	
	float sizemult = 16.0 * this.get_u16("fxholypower") * 0.4;//effect intensity p much
	...
	{
		SColor elecolor(255, 245 + rando.NextRanged(10), 190 + rando.NextRanged(20), 90 + rando.NextRanged(20));
