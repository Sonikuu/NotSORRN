...
void pureFxRender(CBlob@ this)
{
	array<Vertex> vertlist(0);
	
	CShape@ shape = this.getShape();	
	float sizemult = 16 * this.get_u16("fxpurepower");//effect intensity p much
	...
	{
		SColor elecolor(255, 245+ rando.NextRanged(10), 245 + rando.NextRanged(10), 190 + rando.NextRanged(20));
