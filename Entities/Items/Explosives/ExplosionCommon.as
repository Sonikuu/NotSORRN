...
shared void Explode(CBlob@ this, Vec2f pos, f32 radius, f32 damage, string custom_explosion_sound, f32 map_damage_radius, f32 map_damage_ratio, bool map_damage_raycast, u8 custom_hitter, bool should_teamkill)
{
	...
	//actor damage
	u8 hitter = custom_hitter;

	const int r = (radius * (2.0 / 3.0));
	
	Sound::Play(custom_explosion_sound, pos);
	...
	if (getNet().isServer())
	{
		...
		for (uint i = 0; i < blobs.length; i++)
		{
			...
			HitBlob(this, pos, hit_blob, radius, damage, hitter, true, should_teamkill);
		}
	}
}
...
void Explode(CBlob@ this, f32 radius, f32 damage)
{
	...
	string custom_explosion_sound = "Bomb.ogg";
	if (this.exists("custom_explosion_sound"))
	{
		custom_explosion_sound = this.get_string("custom_explosion_sound");
	}
	...
	Explode(this, pos, radius, damage, custom_explosion_sound, map_damage_radius, map_damage_ratio, map_damage_raycast, hitter, should_teamkill);
...
{
	Vec2f pos = this.getPosition();
	return HitBlob(this, pos, hit_blob, radius, damage, hitter,
