...
{	
	...
	if(blob.getPlayer() is null && isServer())
	{
		...
		if(getGameTime() % 5 == 0 && XORRandom(6) == 0)
		{
		...
		//if(gametime % 15 == 0)
		{
			...
			if(wanderstate == 0)
			{
				...
				if(map.isTileSolid(blob.getPosition() + Vec2f(-8, 0)))
...
void getTarget(CBrain@ this)
{
	...
	for (uint i = 0; i < getPlayerCount(); i++)
	{
		...
		if (b !is null && !b.hasTag("dead") && b.getTeamNum() != blob.getTeamNum()) //this search should be fairly quick
		{
