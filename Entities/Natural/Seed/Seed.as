...
void seedGrowthTick(CBlob@ this)
{
	this.set_u16("seed_grow_time", Maths::Max(this.get_u16("seed_grow_time") - 30, OPT_TICK + 1));
	onTick(this);
}
...
void onInit(CBlob@ this)
{
	...
	this.set("growthtick", @seedGrowthTick);
...
void LoadSprite(CBlob@ this, string filename, u8 spriteIndex)
{
	...
	if (spriteIndex == 2 || spriteIndex == 3 || spriteIndex == 7 || spriteIndex == 8)
	{
		frameWidth = 16;
		frameHeight = 16;
	}
