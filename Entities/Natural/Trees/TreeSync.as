...
void InitTree(CBlob@ this, TreeVars@ vars)
{
	...
	this.set("growthtick", @treeGrowTick);
...
void treeGrowTick(CBlob@ this)
{
	TreeVars@ vars;
	this.get("TreeVars", @vars);
	if(vars !is null)
	{
		DoGrow(this, vars, true);
	}
}

void DoGrow(CBlob@ this, TreeVars@ vars, bool fromother = false)
{
	...
	if (!fromother && vars.grown_times >= 15 && this.getCurrentScript() !is null)
		this.getCurrentScript().tickFrequency = 0;
