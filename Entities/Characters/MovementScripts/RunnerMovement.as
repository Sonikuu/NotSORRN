...
void onInit(CMovement@ this)
{
	...
	this.getBlob().set_f32("basegrav", 1.0);
}
...
void onTick(CMovement@ this)
{
	...
	//getting f32 here cause cant force an added script to run before/after this one :V
	...
	if (moveVars.jumpFactor > 0.01f && !isknocked)
	{
		...
		if (up && vel.y > -moveVars.jumpMaxVel * moveVars.jumpFactor)
		{
